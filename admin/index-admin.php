                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Jumlah Users</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $cu?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Selamat Datang Admin <b><u><?=$_SESSION['name']?></u></b></h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <p class="mb-0">Untuk fitur admin sendiri yaitu dapat memanajemen akun admin, dokter, dan user(user android) .</p>
                                </div>
                            </div>
