...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2023 at 04:05 PM
...
--
ALTER TABLE `diagnoses`
  MODIFY `idDiagnose` int(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `diseases`
--
ALTER TABLE `diseases`
  MODIFY `idDisease` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1018;
...
--
ALTER TABLE `rules`
  MODIFY `rulesId` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5010;
...
ALTER TABLE `diagnoses`
  ...
  ADD CONSTRAINT `diagnoses_ibfk_2` FOREIGN KEY (`idSymptom`) REFERENCES `symptoms` (`idSymptom`) ON DELETE CASCADE ON UPDATE CASCADE;
